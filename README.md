...
See [`VERSION`](VERSION). Current: **1.1.3**
...
```bash
curl -fsSL -O https://github.com/arma35/awgstat/releases/download/v1.1.3/awgstat-1.1.3.tar.gz
tar -xzf awgstat-1.1.3.tar.gz
cd awgstat-1.1.3
